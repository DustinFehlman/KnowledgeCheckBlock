    ...
    return (
        <div className="wrapper">
            ...
            <>
                ...
                {submittedAnswer && <KnowledgeCheckFeedback isCorrect={submittedAnswer.isCorrect}
                                                            blurb={submittedAnswer.blurb}/>}
                {!submittedAnswer && <Button value={"Submit"}
                                             isDisabled={!Boolean(selectedAnswer)}
                                             onClick={() => _submitAnswer(selectedAnswer, setSubmittedAnswer)}/>}
                {submittedAnswer && <KnowledgeCheckTryAgainButton
